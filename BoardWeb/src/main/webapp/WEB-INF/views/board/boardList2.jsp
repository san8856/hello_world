...
<!-- https://datatables.net/examples/data_sources/dom.html  라이브러리 -->

<link rel="stylesheet" href="https://cdn.datatables.net/2.2.2/css/dataTables.dataTables.css"> <!-- css -->
<script src="https://code.jquery.com/jquery-3.7.1.js"></script>                               <!-- 자바스크립트 -->
<script src="https://cdn.datatables.net/2.2.2/js/dataTables.js"></script>                     <!-- 자바스크립트 -->
