...
<form action="modifyForm.do">
	...
	<table class="table">
		...
		<tr>
			<th>작성일시</th>
			<td colspan="4"><fmt:formatDate value="${board.writeDate }"
...
<!-- 댓글관련 -->
<p>
	<input type="text" id="addContent" class="col-sm-8" placeholder="댓글을 입력하세요.">
	<button class="btn btn-primary" id="addRow">댓글등록</button>
	<button class="btn btn-danger" id="delRow">댓글삭제</button>
</p>
